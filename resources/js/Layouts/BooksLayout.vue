...
const onSwiper = (swiper) => {
    slider.value = swiper;
    console.log(slider.value.params)
};
</script>
...
<template>
    ...
    <div class="block h-60 relative">
        <SwiperLoader :class="'absolute z-50 bottom-0 right-0 mb-2 mr-2'" :duration="delay+slideSpeed+'ms'" :width="'48px'" :height="'48px'"></SwiperLoader>
